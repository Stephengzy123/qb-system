...
export default async function Page(){
  ...
  return work.status==='submitted'?<StudentResult result={result} assignmentId={learningId(90)} />:<StudentWork studentId={learningId(50)} assignmentId={learningId(90)} discardedRevision={work.discardedRevision??0} questions={workQuestions} revision={work.revision} answers={work.answers.map((a:{questionId:string;choiceId:string|null})=>({question_id:a.questionId,choice_id:a.choiceId}))} />;
}
