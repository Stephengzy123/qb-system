...
export async function StudentAccountContent({ tab = "profile" }: { tab?: "profile" | "security" | "classes" | "appearance" }) {
  ...
  return <div className="student-shell">
    ...
    <main className="student-main"><header className="page-header compact"><div><p className="eyebrow">ACCOUNT</p><h1>Account settings</h1><p className="lede">Manage your profile, password, and access.</p></div></header><AccountSettings tab={tab} user={user} memberships={memberships} /></main>
  </div>;
}
