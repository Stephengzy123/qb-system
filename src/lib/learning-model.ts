...
export type HistoryItem={revision?:number;practice_student_id?:string|null;id:string;title:string;class_name:string;status:string;assignment_status:string;correct:number;graded:number;total:number;submitted_at:Date|null;due_at:Date|null};
